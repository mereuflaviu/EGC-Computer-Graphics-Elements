...
class Camera {
 public:
  ...
  void TranslateRight(float distance) {
    ...
    // glm::vec3 dir = glm::cross(right, glm::normalize(glm::vec3(1, 1, 0)));
  ...
  void RotateFirstPerson_OX(float angle) {
    ...
    glm::vec4 new_fwd = rot_mat * glm::vec4(forward, 1);
  ...
  void RotateFirstPerson_OY(float angle) {
    ...
    glm::mat4 rot_mat =
        glm::rotate(glm::mat4(1.f), angle, glm::normalize(glm::vec3(0, 1, 0)));

    glm::vec4 new_fwd = rot_mat * glm::vec4(forward, 1);
    forward = glm::normalize(glm::vec3(new_fwd));

    glm::vec4 new_right = rot_mat * glm::vec4(right, 1);
  ...
  void RotateFirstPerson_OZ(float angle) {
    ...
    glm::mat4 rot_mat = glm::rotate(glm::mat4(1.f), angle, forward);

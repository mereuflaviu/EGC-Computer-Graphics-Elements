...
{
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(1.1, 0.0, 0.0));
...

    {
        ...
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.54f, 1.15f, 0.46f));
...
void Lab8::OnInputUpdate(float deltaTime, int mods)
{
    ...
    if (!window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT))
    {
        ...
        {
            //grow the angle of the light

            cutoffAngle += deltaTime * ANGLE_SPEEDUP;
            
            //the angle of the light is limited to 360 degrees
            cutoffAngle = min(cutoffAngle, 360.f);
        ...
        {
            cutoffAngle -= deltaTime * ANGLE_SPEEDUP;
            cutoffAngle = cutoffAngle < 0 ? 0 : cutoffAngle;
        }

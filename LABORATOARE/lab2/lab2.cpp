...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            // TODO(student): Complete the vertices data for the cube mesh
             ...
             VertexFormat(glm::vec3(0, 1,  1), glm::vec3(0, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
              VertexFormat(glm::vec3(1, 1,  1), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
              VertexFormat(glm::vec3(0, 0,  0), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
              ...
              VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
    ...
    // by definition!
    {
        vector<VertexFormat> vertices
        {
              ...
              VertexFormat(glm::vec3(0, 0,  1), glm::vec3(1, 1, 1.6f), glm::vec3(0.2, 0.8, 0.6)),
              VertexFormat(glm::vec3(0, 1,  0), glm::vec3(1.3f, 0.5f, 0), glm::vec3(0.2, 0.8, 0.6)),
              VertexFormat(glm::vec3(1, 0,  0), glm::vec3(1, 0, 1.2f), glm::vec3(0.2, 0.8, 0.6)),
    ...
    // TODO(student): Create a square using two triangles withs
...

    {
        ...
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1.f, 0.f, 0.f), glm::vec3(0.2, 0.8, 0.6)),
            //VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0.f, 0.f, 1.f), glm::vec3(0.2, 0.8, 0.6)),
...

    {
        vector<VertexFormat> vertices
        {
              VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),//0
              VertexFormat(glm::vec3(0, 0,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),//1
              VertexFormat(glm::vec3(0, 1,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),//2

              VertexFormat(glm::vec3(0, 0,  0), glm::vec3(1, 1, 1.6f), glm::vec3(0.2, 0.8, 0.6)),//3
              VertexFormat(glm::vec3(0, 1,  0), glm::vec3(1, 1, 1.6f), glm::vec3(0.2, 0.8, 0.6)),//4
              VertexFormat(glm::vec3(1, 0,  0), glm::vec3(1, 1, 1.6f), glm::vec3(0.2, 0.8, 0.6)),//5
              
              VertexFormat(glm::vec3(0, 0,  0), glm::vec3(1.3f, 0.5f, 0), glm::vec3(0.2, 0.8, 0.6)),//6
              VertexFormat(glm::vec3(1, 0,  0), glm::vec3(1.3f, 0.5f, 0), glm::vec3(0.2, 0.8, 0.6)),//7
              VertexFormat(glm::vec3(0, 0,  1), glm::vec3(1.3f, 0.5f, 0), glm::vec3(0.2, 0.8, 0.6)),//8
              
              VertexFormat(glm::vec3(0, 0,  1), glm::vec3(1, 0, 1.2f), glm::vec3(0.2, 0.8, 0.6)),//9
              VertexFormat(glm::vec3(0, 1,  0), glm::vec3(1, 0, 1.2f), glm::vec3(0.2, 0.8, 0.6)),//10
              VertexFormat(glm::vec3(1, 0,  0), glm::vec3(1, 0, 1.2f), glm::vec3(0.2, 0.8, 0.6)),//11
        ...
        CreateMesh("tetrahedron2", vertices, indices);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(0, -1.5f, 0.5f), glm::vec3(0.5f));


    // TODO(student): Draw the tetrahedron

    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(-3, 1, 0.5f), glm::vec3(1.0f));

    // TODO(student): Draw the square


    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(0, 1, 0.5f), glm::vec3(0.750f));

    //bonus
    RenderMesh(meshes["tetrahedron2"], shaders["VertexColor"], glm::vec3(3, 2, 0.5f), glm::vec3(1.0f));

...
void Lab5::Update(float deltaTimeSeconds)
{
    ...
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::scale(modelMatrix, glm::vec3(1, 1.5, 1));
        modelMatrix = glm::translate(modelMatrix, glm::vec3(2, 2.f, 1));
       // modelMatrix = glm::scale(modelMatrix, glm::vec3(1, 1.5, 1));
        modelMatrix = glm::rotate(modelMatrix, cos( -deltaTimeSeconds * 100), glm::vec3(2, 1.5, 0.5));
        //modelMatrix = glm::scale(modelMatrix, glm::vec3(1, 1.5, 1));
        RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
...

    {
        ...
        modelMatrix = glm::rotate(modelMatrix, cos(-deltaTimeSeconds * 100), glm::vec3(2, 1.5, 0.5));
        //modelMatrix = glm::scale(modelMatrix, glm::vec3(1, 1.5, 1));
        modelMatrix = glm::rotate(modelMatrix, sin(deltaTimeSeconds / 10), glm::vec3(1, 3.5, 1));
        RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
